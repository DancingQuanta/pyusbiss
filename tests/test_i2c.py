...
class I2ctestCase(unittest.TestCase):
    ...
    def _scan_devices(self):
        ...
        i2cchannel = i2c.I2C(self._usbissdev, 'H', 100)
    ...
    def test1_parameters_H(self):
        self.assertIsNotNone(i2c.I2C(self._usbissdev, 'H', 100))

    def test2_parameters_H(self):
        self.assertIsNotNone(i2c.I2C(self._usbissdev, 'S', 100))

    def test3_parameters_handshaking_invalid(self):
        with self.assertRaises(ValueError):
            i2c.I2C(self._usbissdev, 'P', 100)

    def test4_parameters_Hardware_100khz(self):
        self.assertIsNotNone(i2c.I2C(self._usbissdev, 'H', 100))

    def test5_parameters_Hardware_400khz(self):
        self.assertIsNotNone(i2c.I2C(self._usbissdev, 'H', 400))

    def test6_parameters_Hardware_1000khz(self):
        self.assertIsNotNone(i2c.I2C(self._usbissdev, 'H', 1000))
 
    def test7_parameters_Software_20khz(self):
        self.assertIsNotNone(i2c.I2C(self._usbissdev, 'S', 20))

    def test8_parameters_Software_50khz(self):
        self.assertIsNotNone(i2c.I2C(self._usbissdev, 'S', 50))

    def test9_parameters_Software_100khz(self):
        self.assertIsNotNone(i2c.I2C(self._usbissdev, 'S', 100))

    def test10_parameters_Software_400khz(self):
        self.assertIsNotNone(i2c.I2C(self._usbissdev, 'S', 400))
    ...
    def test12_parameters_Hardware_invalidspeed(self):
        with self.assertRaises(ValueError):
            i2c.I2C(self._usbissdev, 'H', 50)

    def test13_parameters_Software_invalidspeed(self):
        with self.assertRaises(ValueError):
            i2c.I2C(self._usbissdev, 'S', 1000)
